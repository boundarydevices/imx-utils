...
public:
	...
	// get AVC headers
	bool getSPS( void const *&sps, unsigned &len){ sps=spsdata; len=spslen ; return (0 < spslen); }
	bool getPPS( void const *&pps, unsigned &len){ pps=ppsdata; len=ppslen ; return (0 < ppslen); }
	~h264_encoder_t(void);
private:
#if 0
	struct frame_buf {
